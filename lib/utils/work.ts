...
export const WorkList: Work[] = [
    ...
    },
    {
        ...
        role: "full stack developer freelance",
        link: "https://www.boulevardlegacy.com/",
        location: "United States (Remote)",
        timeline: "Jul 2025 - Nov 2025",
        locationMobile: "usa - Remote",
        timelineMobile: "July 2025 - November 2025",
        slug: "boulevard-legacy",
        techStack: ["React", "Next.js", "React Native", "TypeScript", "Tailwind CSS", "Node.js", "Express.js", "Firebase", "Stripe"],
        details: [
            "Built full-stack video analysis product",
            "Developed a full-stack social media kit generator",
            "Designed and developed Marketing Agency landing page",
            "Worked on finance mobile app"
        ]
    },
    {
        companyName: "keryar",
        ...
        details: [
            "Worked on Teacher's Performance Evaluation Scheme project.",
